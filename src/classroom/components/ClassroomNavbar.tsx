...
const ClassroomNavbar: React.FC<ClassroomNavbarProps> = () => (
    <header className="bg-dark-light px-6 py-4 flex items-center justify-between">
        ...
        <button
            ...
            className="flex items-center space-x-2 bg-primary hover:bg-primary-hover text-light px-4 py-2 rounded-lg transition-colors"
        >
            <span>Regresar a TutorMatch</span>
        </button>
